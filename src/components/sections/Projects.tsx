...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      id: 5,
      title: t('projects.list.inventory_system.title'),
      description: t('projects.list.inventory_system.description'),
      image: '📦', // Placeholder - sistema de inventarios
      technologies: ['Angular 18', 'Spring Boot', 'PostgreSQL', 'JWT', 'PrimeNG', 'WebSocket', 'Docker'],
      company: t('projects.list.inventory_system.company'),
      client: t('projects.list.inventory_system.client'),
      period: t('projects.list.inventory_system.period'),
      liveUrl: 'https://inventory-system-frontend-vtdg.onrender.com/login',
      githubUrl: 'https://github.com/leninalbino/inventory-system-frontend',
      featured: true,
      type: t('projects.list.inventory_system.type')
    },
    {
      id: 6,
